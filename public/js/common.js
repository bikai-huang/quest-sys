...
// var host = 'http://115.159.147.196';
// var host = 'http://csgs.bnu.edu.cn';
	...
	$.ajax({
		...
		success: function(res){
			...
			if(roleType <= 1) {
				...
				html += '<a class="user-name" href="import-user.html"><i class="icon questions-icon"><em></em></i><span>填卷帐号管理</span></a>';
